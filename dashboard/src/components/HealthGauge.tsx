        ...
        <div>
          ...
          <p className="text-slate-300 text-[11px] leading-relaxed mt-0.5">
            {status === "danger"
              ...
              : "Dispute ratio is firmly within the safe operating envelope (< 0.30%). Autonomous Gemini 3 Flash multimodal dossiers are continuously recovering contested funds."}
          </p>
        </div>
      </div>
    </div>
